...
<table style="border: 1px solid black;">
    ...
    <tr>
        ...
        <th style="border: 1px solid black;"><strong>Mantap(%)</strong></th>
        <th style="border: 1px solid black;"><strong>Tidak Mantap(%)</strong></th>
    </tr>
    </thead>
    <tbody>
    @foreach($survey as $item)
        <tr>
            ...
            <td style="border: 1px solid black;">{{ $item['mantap'] }}</td>
            <td style="border: 1px solid black;">{{ $item['tmantap'] }}</td>
        </tr>
    @endforeach
    </tbody>
</table>