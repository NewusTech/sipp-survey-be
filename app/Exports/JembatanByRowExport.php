...
class JembatanByRowExport implements FromView
{
    protected $tahun;
    protected $id_jembatan;

    public function __construct($tahun, $id_jembatan)
    {
        $this->tahun = $tahun;
        $this->id_jembatan = $id_jembatan;
    }
    ...
    public function view(): View
    {
        ...
        if ($this->id_jembatan) {
            $query->whereIn('jembatan.id', $this->id_jembatan);
        }
